<div class="box">
    ...
    <div class="box-body">
        ...
        // Form buka 
        echo form_open_multipart(base_url('admin/sdm/tambah'), array('id' => 'form-tambah-sdm', 'class' => 'form-horizontal'));
        ?>
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        rows="8"
                        placeholder="Masukkan deskripsi atau bio singkat..."><?php echo set_value('deskripsi') ?></textarea>
            ...
            <div class="col-md-4">
                ...
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0 mt-2">
                        ...
                        <li>Foto akan digunakan untuk profil SDM</li>
                    </ul>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        // Form validation
        $('#form-tambah-sdm').on('submit', function(e) {
