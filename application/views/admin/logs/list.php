        ...
        <div class="card card-info">
            ...
            <div class="col-6">
                <p class="btn btn-group">
                    <button id="delete-all-logs" class="btn btn-danger btn-sm" onclick="delete_logs()"><i class="fa fa-trash"></i> Delete All</button>
                </p>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
...
<script type="text/javascript">
    ...
    function delete_logs() {
        if (confirm('Are you sure delete this data?')) {
            var btn = document.getElementById('delete-all-logs');
            if (btn) {
                btn.disabled = true;
