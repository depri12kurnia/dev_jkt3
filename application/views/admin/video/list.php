            ...
            foreach ($video as $video) { ?>
                <tr class="odd gradeX">
                    ...
                    <td>
                        ...
                        <br><small>Lang: <span class="flag-icon <?php if ($video->bahasa == "English") {
                                                                    echo "flag-icon-gb";
                                                                } else {
                                                                    echo "flag-icon-id";
                                                                } ?>"></span> <?php echo $video->bahasa ?></small>
                    </td>
                    <td><?php echo $video->posisi ?></td>
                    <td><?php echo character_limiter(strip_tags($video->keterangan), 100); ?></td>
                    <td>
