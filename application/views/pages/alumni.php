                ...
                <div class="page-header">
                    ...
                    <div class="page-header-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo character_limiter(strip_tags($pages->judul_pages), 30); ?></li>
                        </ol>
                    </div>
                    <!-- .page-header-content -->
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="blog-items">
                            <?php if ($pages->gambar != "") { ?>
                                <div class="blog-img">
                                    <a href="#"><img src="<?php echo base_url('assets/upload/pages/' . $pages->gambar) ?>" alt="blog-img-10" class="img-responsive lazyload" /></a>
                                </div>
                            <?php } ?>
