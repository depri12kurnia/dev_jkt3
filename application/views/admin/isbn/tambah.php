...
// Form open
echo form_open_multipart(base_url('admin/isbn/tambah'));
?>
...
<div class="row">
    <div class="col-md-10">
        <div class="form-group form-group-lg">
            <label>Judul</label>
            <input type="text" name="judul" class="form-control" placeholder="Judul" required="required" value="<?php echo set_value('judul') ?>" autofocus>
        </div>
    </div>
    ...
    <div class="col-md-10">
        <div class="form-group form-group-lg">
            <label>Penulis</label>
            <input type="text" name="penulis" class="form-control" placeholder="Penulis" required="required" value="<?php echo set_value('penulis') ?>">
        </div>
    </div>
