...
class Home extends CI_Controller
{
	...
	public function index()
	{
		...
		$tautan 		= $this->tautan_model->home();
		$mitra 		    = $this->mitra_model->home();
		$jurusan1 		= $this->jurusan_model->home();
		$prodi 			= $this->prodi_model->home();
		$pendidikan 	= $this->nav_model->nav_pendidikan();
