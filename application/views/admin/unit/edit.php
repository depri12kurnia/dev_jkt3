...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">
            <i class="fa fa-edit"></i> Edit Unit: <?php echo htmlspecialchars($unit->nama) ?>
        </h3>
        <div class="box-tools pull-right">
            <a href="<?php echo base_url('admin/unit') ?>" class="btn btn-default btn-sm">
                <i class="fa fa-arrow-left"></i> Kembali ke Daftar
            </a>
            <a href="<?php echo base_url('admin/unit/detail/' . $unit->id) ?>" class="btn btn-info btn-sm">
                <i class="fa fa-eye"></i> Lihat Detail
            </a>
            <a href="<?php echo base_url('admin/unit/preview/' . $unit->id) ?>" target="_blank" class="btn btn-primary btn-sm">
...
<div class="box">
    ...
    <div class="box-body">
        ...
        echo form_open_multipart(base_url('admin/unit/edit/' . $unit->id), array('id' => 'form-edit-unit'));
        ?>
        ...
        <div class="form-group">
            ...
            <input type="text"
                ...
                value="<?php echo set_value('nama', $unit->nama) ?>"
                maxlength="100"
                required>
        ...
        <div class="form-group">
            ...
            <input type="text"
                ...
                value="<?php echo set_value('slug', $unit->slug) ?>"
                maxlength="100">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="deskripsi"
                ...
                rows="6"
                placeholder="Masukkan deskripsi unit"><?php echo set_value('deskripsi', $unit->deskripsi) ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text"
                ...
                value="<?php echo set_value('tagline', $unit->tagline) ?>"
                maxlength="200">
        </div>

        <div class="form-group">
            <label>Keunggulan / Fitur Unit <small>(opsional, icon, warna, dan teks)</small></label>
        ...
        <div class="form-group">
            ...
            <?php if (!empty($unit->image)) { ?>
                <div style="margin-bottom:10px;">
                    <img src="<?php echo base_url('assets/images/unit/' . $unit->image) ?>" alt="Image" style="max-width:100px;max-height:100px;">
                    <a href="#" class="btn btn-xs btn-danger delete-image" data-id="<?php echo $unit->id ?>"><i class="fa fa-trash"></i> Hapus Gambar</a>
                </div>
            <?php } ?>
        ...
        <div class="form-group" style="margin-top: 30px;">
            ...
            <div class="btn-group">
                ...
                <a href="<?php echo base_url('admin/unit') ?>" class="btn btn-default">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.delete-image', function(e) {
            ...
            if (confirm('Apakah Anda yakin ingin menghapus gambar ini?')) {
                $.ajax({
                    url: '<?php echo base_url("admin/unit/delete_image/") ?>' + id,
                    type: 'POST',
                    dataType: 'json',
