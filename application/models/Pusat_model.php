...
class Pusat_model extends CI_Model
{
    ...
    public function tambah($data)
    {
        ...
        return $this->db->insert('pusat', $data);
    }
    ...
    public function edit($data)
    {
        ...
        $this->db->where('id', $id);
        return $this->db->update('pusat', $data);
    }
    ...
    public function delete($data)
    {
        ...
        return $this->db->delete('pusat');
    }

    // Search pusat berdasarkan nama/deskripsi
    ...
    public function validate_data($data, $id = null)
    {
        ...
        if (empty($data['nama'])) {
            $errors[] = 'Nama pusat harus diisi';
        } elseif (strlen($data['nama']) > 100) {
            $errors[] = 'Nama pusat maksimal 100 karakter';
        }
    ...
    {
        return $this->db->update_batch('pusat', $data, $key);
    }
    ...
    // Get all pusat for listing
    public function get_all_pusat()
    {
        $this->db->order_by('nama', 'ASC');
        $query = $this->db->get('pusat');
        return $query->result();
    }

    /**
     * Check if pusat exists by slug
     */
    public function pusat_exists($slug)
    {
        $this->db->where('slug', $slug);
