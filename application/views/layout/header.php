                    ...
                    <div class="col-md-9">
                        <ul class="list-inline mt-3 d-flex flex-wrap gap-2 justify-content-end d-none d-lg-flex">
                            <li class="list-inline-item">
                                <a href="https://wa.me/6281113102256" target="_blank" title="Hubungi Kami via WhatsApp"
                                    class="footer-social rounded-circle d-flex align-items-center justify-content-center">
                                    <i class="fa fa-whatsapp"></i>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a href="https://instagram.com/polkesjakarta3" target="_blank" title="Follow Kami di Instagram"
                                    class="footer-social rounded-circle d-flex align-items-center justify-content-center">
                                    <i class="fa fa-instagram"></i>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a href="https://www.tiktok.com/@poltekkesjakarta3" target="_blank" title="Follow Kami di TikTok"
                                    class="footer-social rounded-circle d-flex align-items-center justify-content-center">
                            ...
                            <li class="list-inline-item">
                                <a href="https://www.youtube.com/channel/UChzyWfEnnmomSdNLkt6Iutw" target="_blank" title="Subscribe Kami di YouTube"
                                    class="footer-social rounded-circle d-flex align-items-center justify-content-center">
                                    <i class="fa fa-youtube"></i>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a href="https://web.facebook.com/POLTEKKES.JAKARTA3" target="_blank" title="Follow Kami di Facebook"
                                    class="footer-social rounded-circle d-flex align-items-center justify-content-center">
                                    <i class="fa fa-facebook"></i>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a href="https://x.com/PoltekkesJkt3" target="_blank" title="Follow Kami di Twitter"
                                    class="footer-social rounded-circle d-flex align-items-center justify-content-center">
                                    <i class="fa fa-twitter"></i>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a href="<?php echo base_url('helpdesk') ?>" target="_blank" title="Hubungi Kami via Helpdesk" class="footer-social rounded-circle d-flex align-items-center justify-content-center">
                                    <i class="fa fa-question"></i>
                                </a>
                            </li>
                        </ul>
                        <ul class="list-inline mt-2 d-flex flex-wrap gap-2 justify-content-end d-none d-lg-flex">
                            <li class="nav-item"><a href="https://sipenmaru.poltekkesjakarta3.ac.id/" target="_blank" title="Penerimaan Mahasiswa Baru">SPMB Prestasi</a></li> |
