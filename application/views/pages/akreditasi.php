        ...
        <div class="row">
            <div class="our-services-option">
                <div class="section-header">
                    <h2><?php //echo $title 
                        ?> Akreditasi Institusi dan Prodi</h2>
...
<div class="modal fade" id="previewModal" tabindex="-1" role="dialog" aria-labelledby="previewModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl preview-modal-dialog" role="document">
...
<style>
    ...
    #previewModal .modal-body {
        ...
        overflow: auto;
        padding: 0;
        /* make the viewer use full space */
    }

    /* Make PDF pages scale to container width */
    #pdfViewer {
        width: 100%;
        height: 100%;
    }
    ...
    /* Small devices: fullscreen-like modal */
    ...
    /* Large devices: keep a comfortable max width */
