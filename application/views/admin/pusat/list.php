...
<div class="row mb-3">
    <div class="col-md-6">
        <form method="GET" action="<?php echo base_url('admin/pusat/search') ?>">
            <div class="input-group">
                <input type="text" class="form-control" name="q" placeholder="Cari pusat..." value="<?php echo isset($keyword) ? $keyword : '' ?>">
    ...
    <div class="col-md-6 text-right">
        <a href="<?php echo base_url('admin/pusat/export') ?>" class="btn btn-success btn-sm">
            <i class="fa fa-download"></i> Export CSV
        </a>
        <a href="<?php echo base_url('admin/pusat/import') ?>" class="btn btn-info btn-sm">
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Data pusat</h3>
    </div>
    <div class="box-body">
        <table class="table table-bordered table-hover table-striped" id="example1">
            ...
            <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($row->image)) { ?>
                                    <img src="<?php echo base_url('assets/images/pusat/' . $row->image) ?>" alt="Image" style="max-width:60px;max-height:60px;">
                                <?php } else { ?>
                ...
                <?php } else { ?>
                    <tr>
                        <td colspan="8" class="text-center text-muted">Belum ada data pusat</td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Deskripsi pusat</h4>
            </div>
...
<script>
    ...
    function confirmation(event) {
        ...
        Swal.fire({
            ...
            text: "Data pusat yang dihapus tidak dapat dikembalikan!",
            icon: 'warning',
