            ...
            <div class="container py-4">
                <div class="row g-4">
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <!-- <?php echo form_open('newsletter/subscribe', ['id' => 'subscribe-form', 'class' => 'contact-form']); ?>
                        <div class="input-group mb-2">
                            <input type="email" class="form-control rounded-start" name="email" placeholder="Masukkan email Anda">
                            <button class="btn btn-primary-dark rounded-end" type="submit">Berlangganan</button>
                        </div>
                        <?php echo form_close(); ?> -->
