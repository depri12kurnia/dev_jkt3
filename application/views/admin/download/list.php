...
<br>
<p class="btn-group">
    <a href="<?php echo base_url('admin/download/listLayananAkademik') ?>" class="btn btn-default btn-sm">
        <i class="fa fa-list"></i> Layanan Akademik</a>
    <a href="<?php echo base_url('admin/download/listLayananKemahasiswaan') ?>" class="btn btn-default btn-sm">
        <i class="fa fa-list"></i> Layanan Kemahasiswaan</a>
    <a href="<?php echo base_url('admin/download/listLayananPelanggan') ?>" class="btn btn-default btn-sm">
        <i class="fa fa-list"></i> Layanan Pelanggan</a>
    <a href="<?php echo base_url('admin/download/listLayananPerpustakaan') ?>" class="btn btn-default btn-sm">
        <i class="fa fa-list"></i> Layanan Perpustakaan</a>
</p>

<br>
<p class="btn-group">
    <a href="<?php echo base_url('admin/download/listDokumen') ?>" class="btn btn-default btn-sm">
        <i class="fa fa-list"></i> Daftar Dokumen</a>
    <a href="<?php echo base_url('admin/download/listAkuntabilitas') ?>" class="btn btn-default btn-sm">
        <i class="fa fa-list"></i> Daftar Akuntabilitas</a>
    <a href="<?php echo base_url('admin/download/listStandardPelayanan') ?>" class="btn btn-default btn-sm">
        <i class="fa fa-list"></i> Daftar Standard Pelayanan</a>
    <a href="<?php echo base_url('admin/download/listPrestasi') ?>" class="btn btn-default btn-sm">
        <i class="fa fa-list"></i> Daftar Prestasi</a>
</p>

<br>
<p class="btn-group">
    <a href="<?php echo base_url('admin/download/listPeraturanAsn') ?>" class="btn btn-default btn-sm">
        <i class="fa fa-list"></i> Peraturan ASN</a>
    <a href="<?php echo base_url('admin/download/listPeraturanDosen') ?>" class="btn btn-default btn-sm">
        <i class="fa fa-list"></i> Peraturan Dosen</a>
</p>
