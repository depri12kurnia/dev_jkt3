        ...
        <div class="row">
            <div class="our-services-option">
                <div class="section-header">
                    <h2><?php //echo $title 
                        ?> List Dokumen Kemahasisaan</h2>
                    <p>Sipenmaru, Registrasi Mahasiswa, KTM, PKKMB dll</p>
                </div>
                <!-- .section-header -->
                        ...
                        <div class="card border-0 shadow-sm h-100">
                            <div class="col-md-12">
                                <div class="table-responsive mailbox-messages">
                                    <h2 class="contact-title">Layanan Kemahasiswaan</h2>
                                    <!-- Custom Filter -->
                                    <!-- End Custom Filter -->
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var dismissBtns = document.querySelectorAll('#previewModal [data-dismiss] ,[data-bs-dismiss]');
