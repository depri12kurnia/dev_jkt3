<button class="btn btn-primary" data-toggle="modal" data-target="#Tambahpusat">
    <i class="fa fa-plus"></i> Tambah pusat
</button>

<div class="modal fade" id="Tambahpusat" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">
                    <i class="fa fa-plus"></i> Tambah Data pusat
                </h4>
            </div>
            <div class="modal-body">
                ...
                // Form buka - sesuai controller pusat
                echo form_open_multipart(base_url('admin/pusat'), array('id' => 'form-tambah-pusat'));
                ?>
                ...
                <div class="form-group">
                    ...
                    <textarea id="deskripsi"
                        ...
                        rows="6"
                        placeholder="Masukkan deskripsi pusat"><?php echo set_value('deskripsi') ?></textarea>
                </div>
                ...
                <div class="form-group">
                    <label for="features">Keunggulan / Fitur pusat <small>(opsional, satu per baris)</small></label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="form-tambah-pusat" class="btn btn-success">
