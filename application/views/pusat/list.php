                ...
                <div class="page-header">
                    ...
                    <div class="page-header-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo $pusat_data->nama; ?></li>
                        </ol>
                    </div>
                    <!-- .page-header-content -->
                </div>
                ...
                <div class="col-lg-7">
                    <div class="hero-content">
                        ...
                        <div class="hero-badge mb-3">
                            <span class="badge bg-<?php echo !empty($pusat_data->color) ? $pusat_data->color : 'primary'; ?>-subtle text-<?php echo !empty($pusat_data->color) ? $pusat_data->color : 'primary'; ?> px-3 py-2 rounded-pill">
                                <i class="<?php echo !empty($pusat_data->icon) ? $pusat_data->icon : 'bi bi-building'; ?> me-1"></i>
                                <?php echo !empty($pusat_data->status) ? $pusat_data->status : 'Pusat Unggulan'; ?>
                            </span>
                        </div>

                        <!-- Dynamic Title -->
                        <h1 class="hero-title display-5 fw-bold text-dark mb-3">
                            <?php echo $pusat_data->nama; ?>
                        </h1>
                        ...
                        <p class="lead text-muted mb-4 lh-lg">
                            <?php echo !empty($pusat_data->deskripsi) ? $pusat_data->deskripsi : 'Pusat ini berperan penting dalam mendukung visi dan misi institusi melalui layanan dan inovasi terbaik.'; ?>
                        </p>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            $features = [];
                            if (!empty($pusat_data->features)) {
                                $features = json_decode($pusat_data->features, true);
                            }
                        ...
                        <div class="hero-actions">
                            <?php if (!empty($pusat_data->website)): ?>
                                <a href="<?php echo $pusat_data->website; ?>" class="btn btn-<?php echo !empty($pusat_data->color) ? $pusat_data->color : 'primary'; ?> btn-lg me-3" target="_blank">
                ...
                <div class="col-lg-5">
                    <div class="hero-image-wrapper">
                        <div class="image-container">
                            ...
                            <img src="<?php
                                        $image_path = '';
                                        if (!empty($pusat_data->image)) {
                                            $image_path = base_url('assets/images/pusat/' . $pusat_data->image);
                                        } else {
                                            // Generate image name from unit name
                                            $image_name = strtolower(str_replace(' ', '-', $pusat_data->nama)) . '-hero.jpg';
                                            $image_path = base_url('assets/images/pusat/' . $image_name);
                                        }
                                        echo $image_path;
                                        ?>"
                                alt="Pusat <?php echo $pusat_data->nama; ?>"
                                class="img-fluid rounded-4 shadow-lg main-image"
                                loading="lazy"
                                onerror="this.src='<?php echo base_url('assets/images/default-pusat.png'); ?>'">
